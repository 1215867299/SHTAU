...
def parse_args():
	...
	parser.add_argument("--gamma", default=1.5, type=float, help='weight of directAU ')
	...
	parser.add_argument('--tstEpoch', default=50, type=int, help='number of epoch to test while training')
	...
	parser.add_argument('--noiceRate', default=0.5, type=float, help='Ratio of sampled edges')
	parser.add_argument('--patience', default=7, type=int, help='early stop patience')
	parser.add_argument('--save_start', default=10, type=int, help='early stop start save epoch')
